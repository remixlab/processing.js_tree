		...
		public native static final PMatrix3D JavaScriptArray2Matrix3D(JavaScriptObject array, boolean rowMajor)/*-{
			...
			{	
			     var matrix3D = @processing.core.PMatrix3D::new();					
				   matrix3D.@processing.core.PMatrix3D::m00 = check(array[0]); 
				   matrix3D.@processing.core.PMatrix3D::m01 = check(array[4]); 
				   matrix3D.@processing.core.PMatrix3D::m02 = check(array[8]); 
				   matrix3D.@processing.core.PMatrix3D::m03 = check(array[12]); 
				   matrix3D.@processing.core.PMatrix3D::m10 = check(array[1]); 
				   matrix3D.@processing.core.PMatrix3D::m11 = check(array[6]); 
				   matrix3D.@processing.core.PMatrix3D::m12 = check(array[9]); 
				   matrix3D.@processing.core.PMatrix3D::m13 = check(array[13]); 
				   matrix3D.@processing.core.PMatrix3D::m20 = check(array[2]); 
				   matrix3D.@processing.core.PMatrix3D::m21 = check(array[6]); 
				   matrix3D.@processing.core.PMatrix3D::m22 = check(array[10]); 
				   matrix3D.@processing.core.PMatrix3D::m23 = check(array[14]); 
				   matrix3D.@processing.core.PMatrix3D::m30 = check(array[3]); 
				   matrix3D.@processing.core.PMatrix3D::m31 = check(array[7]); 
				   matrix3D.@processing.core.PMatrix3D::m32 = check(array[11]); 
				   matrix3D.@processing.core.PMatrix3D::m33 = check(array[15]);			   			   
				   return matrix3D;		 
			}
	  ...
	  public static final JavaScriptObject  Matrix3D2JavaScriptArray(PMatrix3D matrix3D){  	
		...
		public native static final JavaScriptObject  Matrix3D2JavaScriptArray(PMatrix3D matrix3D, boolean rowMajor)/*-{
			...
			//array row major
			   ...
			   array[6] = matrix3D.@processing.core.PMatrix3D::m12; 
